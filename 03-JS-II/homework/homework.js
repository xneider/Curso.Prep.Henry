...
function esEntero(numero) {
  ...
  // Tu código:
  let x= numero-math.floor(numero);
  if(x!=0 ){
    return true;
  }else{
    return false;
...
function operadoresLogicos(num1, num2, num3) {
  ...
  switch(num1 ,num2, num3){
    ...
    break;
    case num1<0 || num2<0 ||num3<0:return 'hay numeros negativos';
    break;
    case num1>num2 && num1>num3 && num1>0: 'numero 1 es mayor y positivo';
    break;
    case num3>num2 && num3>num1: let x=num3+1; return x;
    break;
